...
data  = np.loadtxt('D:/Esteban VC/Poli JIC/Semestres/2024-1/Control Avanzado/Laboratorio/LaPlantaDelPueblo2.0/escalon25_20_feb.txt', skiprows = 1)
# data  = np.loadtxt('D:/Esteban VC/Poli JIC/Semestres/2022-2/Control Digital/LaboratorioControlDigital/Datos/data.txt', skiprows = 1, delimiter=',')
...
plt.figure()
graficar(tt[len(tg)], y[len(tg)],tt, u, 'Planta vs Modelo POR')
plt.subplot(211)
...
# 0.1081 s + 1
# 
# El retardo es:  0.02239441343664804
#
#Tm --> 0.004413035937646246 segundos
